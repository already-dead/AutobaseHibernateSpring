...
<tr><td>${listElement.getId()}</td><td>${listElement.getDate()}</td><td>${listElement.getAdress()}</td><td>${listElement.getCar()}</td>
...
<input type="hidden" name="flightid" value="${listElement.getId()}">
