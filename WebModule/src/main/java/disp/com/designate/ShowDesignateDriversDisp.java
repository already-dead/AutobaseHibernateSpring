...
import disp.serv.designate.ShowDesignateService;
import exception.ServiceException;
import exception.WebException;

public class ShowDesignateDriversDisp extends ReqDisp {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws WebException {	
		...
		BaseService serv = ShowDesignateService.getService();	
		try {
		...
		redirect(request,response,"/WEB-INF/jsp/disp/designate.jsp",false);
	}
