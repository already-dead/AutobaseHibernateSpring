...
import disp.serv.dispatcher.ShowDispatchersService;
import exception.ServiceException;
import exception.WebException;

public class ShowDispatchersDisp extends ReqDisp {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws WebException {
		...
		BaseService serv = ShowDispatchersService.getService();
		try {
		...
		redirect(request,response,"/WEB-INF/jsp/disp/showDisp.jsp",false);
	}
