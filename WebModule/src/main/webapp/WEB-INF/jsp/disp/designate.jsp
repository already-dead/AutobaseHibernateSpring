...
<tr><td>${listElement.getId()}</td><td>${listElement.getDate()}</td><td>${listElement.getAdress()}</td><td>${listElement.getDriver()}</td><td>${listElement.getCar()}</td>
...
<input type="hidden" name="designateid" value="${listElement.getId()}"> 
<input type="hidden" name="id" value="${requestScope.id}">
