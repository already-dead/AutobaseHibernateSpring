...
<td align="left"><input list="drivers" type="text" name="driver" placeholder="driverID" required>

<datalist id="drivers">
<c:forEach var="listElement" items="${requestScope.drivers}">
<c:if test="${listElement.users.getActive()==1}">
<option value="${listElement.getId()}">
</c:if>
</c:forEach>
</datalist>
...
<td align="left"><input list="cars" name="car" placeholder="carID" required>
